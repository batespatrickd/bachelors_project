...
if __name__ == '__main__':
    ...
    params['vmax'] = 400                 # Default: 30 km/s       #######
    ...
    params['total_mass'] = 1e8          # Default: 1e6 Msun   #########
    params['clobber'] = True           # Default: False         #########
